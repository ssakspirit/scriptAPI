/**
 * Quiz Game System - 퀴즈 게임 시스템
 *
 * [ 기능 설명 ]
 * - 채팅으로 진행하는 퀴즈 게임 시스템입니다.
 * - 관리자가 게임을 시작하면 모든 플레이어가 참여할 수 있습니다.
 * - 복수 정답을 지원하며, 정답을 맞추면 보상을 받을 수 있습니다.
 *
 * [ 사용 방법 ]
 * 1. 채팅창에 "퀴즈시작"을 입력하여 게임을 시작합니다.
 * 2. 화면에 문제가 표시되면 채팅창에 정답을 입력합니다.
 * 3. 정답을 맞추면 다음 문제로 진행됩니다.
 * 4. 모든 문제를 맞추면 게임이 종료됩니다.
 *
 * [ 명령어 ]
 * - "퀴즈시작": 퀴즈 게임을 시작합니다.
 * - "퀴즈중지": 진행 중인 퀴즈 게임을 중지합니다.
 *
 * [ 문제 추가 방법 ]
 * questions 배열에 다음 형식으로 문제를 추가하세요:
 * {
 *     question: "문제 내용",
 *     answers: ["정답1", "정답2", "정답3"]  // 복수 정답 지원
 * }
 *
 * [ 주의사항 ]
 * - 한 번에 하나의 게임만 진행할 수 있습니다.
 * - 정답은 대소문자를 구분합니다.
 * - 게임 중에는 "퀴즈중지"로만 게임을 종료할 수 있습니다.
 */
