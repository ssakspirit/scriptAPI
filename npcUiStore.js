/**
 * NPC UI Store System - NPC 상점 시스템
 *
 * [ 기능 설명 ]
 * - NPC와 상호작용하면 상점 UI가 열립니다.
 * - 플레이어는 에메랄드를 사용하여 아이템을 구매할 수 있습니다.
 * - 구매 수량을 슬라이더로 조절할 수 있습니다.
 *
 * [ 사용 방법 ]
 * 1. "상점"이라는 이름을 가진 NPC를 소환합니다.
 *    명령어: /summon npc "상점"
 *    주의: NPC를 소환한 후 이름을 변경하면 작동하지 않습니다.
 *
 * 2. NPC를 클릭하면 상점 UI가 열립니다.
 *
 * 3. 구매할 아이템을 선택하고 수량을 설정합니다.
 *
 ...
 *
 * [ 상품 추가/수정 방법 ]
 * 1. shopForm 함수의 itemList 배열에 아이템 추가 (29번째 줄)
 * 2. getPrice 함수에 가격 설정 추가 (51-61번째 줄)
 * 3. getItemEn 함수에 영문 아이템 ID 추가 (82-92번째 줄)
 *
 * [ 주의사항 ]
 * - NPC는 반드시 summon 명령어로 이름과 함께 생성해야 합니다.
